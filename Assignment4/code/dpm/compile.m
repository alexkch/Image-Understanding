...
if nargin < 3
 ...
 % fv_compile(opt, verb);
  ...
  d = [mexcmd ' dpm/features/resize.cc']
  eval([mexcmd ' dpm/features/resize.cc']);
  eval([mexcmd ' dpm/features/features.cc']);
  eval([mexcmd ' dpm/gdetect/dt.cc']);
  eval([mexcmd ' dpm/gdetect/bounded_dt.cc']);
  eval([mexcmd ' dpm/gdetect/get_detection_trees.cc']);
  eval([mexcmd ' dpm/gdetect/compute_overlap.cc']);
  ...
  eval([mexcmd ' dpm/gdetect/fconv.cc']);
  ...
  % 1) single-threaded convolution
   eval([mexcmd ' dpm/gdetect/fconv_var_dim.cc']);
else
